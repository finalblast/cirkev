...
@elseif($post->video_link)
    <a href="{{ url($post->slug) }}"><img class="media-object img-rounded" src=" http://img.youtube.com/vi/{{ $post->video_link }}/mqdefault.jpg"  style="width: 100%;" alt="{{ $post->user->name }}" ></a>
